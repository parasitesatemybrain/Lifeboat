...
(function($){	
	...
	_lang = {
		...
		_settings = {
			...
			help: '<img src="images/defaultimg.gif" class="imageHolder" style="max-height:300px;max-width:280px;" name="imagename" onClick="image1();"/>', // Provide help text/html if needed.
	...
	$.fn.jQuizMe = function( wordList, options, userLang ){
		...
		return this.each( function(){
			...
			replaceImage = function() {
			 ...
			 if (image) {
			   $('.imageHolder').attr("src",image).show();
			   $('.q-help-menu').show();
			 } else {
			   $('.imageHolder').hide();
			   $('.q-help-menu').hide();
